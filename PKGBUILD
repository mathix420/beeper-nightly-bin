...
_update_version() {
  ...
  _dl_url="https://api.beeper.com/desktop/download/linux/x64/nightly/com.automattic.beeper.desktop"
  ...
  # nightly builds are named "Beeper-Nightly-X.Y.Z-x86_64.AppImage", stable
  # "Beeper-X.Y.Z-x86_64.AppImage"; grab the first dotted version either way.
  _pkgver_new=$(
    printf '%s' "$_filename" \
